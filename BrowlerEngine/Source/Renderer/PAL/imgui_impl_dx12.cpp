 ...
 void ImGui_ImplDX12_CreateFontsTexture()
{
    ...
    // Upload texture to graphics system
    {
        ...
        ComPtr<ID3D12Resource> pTexture = NULL;
...
bool    ImGui_ImplDX12_CreateDeviceObjects()
{
    ...
    psoDesc.VS = { GUI_vs_vs , sizeof(GUI_vs_vs) };
    ...
    psoDesc.PS = { GUI_ps_ps, sizeof(GUI_ps_ps) };
...
void    ImGui_ImplDX12_InvalidateDeviceObjects()
{
    ...
    g_pRootSignature = nullptr;
    g_pPipelineState = nullptr;
    g_pFontTextureResource = nullptr;
