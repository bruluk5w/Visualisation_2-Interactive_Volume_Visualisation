...
; texture0                          texture     f32          3d      T0             t0     1
;
;
; ViewId state:
;
...
@"\01?texture0@@3V?$Texture3D@V?$vector@M$03@@@@A" = external constant %"class.Texture3D<vector<float, 4> >", align 4

define void @main() {
  %texture0_texture_3d = call %dx.types.Handle @dx.op.createHandle(i32 57, i8 0, i32 0, i32 0, i1 false)  ; CreateHandle(resourceClass,rangeId,index,nonUniformIndex)
  ...
  %7 = call %dx.types.Dimensions @dx.op.getDimensions(i32 72, %dx.types.Handle %texture0_texture_3d, i32 0)  ; GetDimensions(handle,mipLevel)
  %8 = extractvalue %dx.types.Dimensions %7, 2
  %9 = sitofp i32 %8 to float
  %10 = fptosi float %9 to i32
  %11 = sitofp i32 %10 to float
  %12 = fmul fast float %11, 5.000000e-01
  %13 = call %dx.types.ResRet.f32 @dx.op.sample.f32(i32 60, %dx.types.Handle %texture0_texture_3d, %dx.types.Handle %sampler0_sampler, float %1, float %2, float %12, float undef, i32 undef, i32 undef, i32 undef, float undef)  ; Sample(srv,sampler,coord0,coord1,coord2,coord3,offset0,offset1,offset2,clamp)
  ...
  %.i0 = fmul fast float %14, %3
  %.i1 = fmul fast float %15, %4
  %.i2 = fmul fast float %16, %5
  %.i3 = fmul fast float %17, %6
...
!4 = !{!5, null, null, !8}
!5 = !{!6}
!6 = !{i32 0, %"class.Texture3D<vector<float, 4> >"* undef, !"texture0", i32 0, i32 0, i32 1, i32 4, i32 0, !7}
!7 = !{i32 0, i32 9}
!8 = !{!9}
!9 = !{i32 0, %struct.SamplerState* undef, !"sampler0", i32 0, i32 0, i32 1, i32 0, null}
!10 = !{i32 0, %"class.Texture3D<vector<float, 4> >" undef, !11, %"class.Texture3D<vector<float, 4> >::mips_type" undef, !14, %struct.PS_INPUT undef, !16}
!11 = !{i32 20, !12, !13}
...
!18 = !{i32 6, !"color", i32 3, i32 16, i32 4, !"COLOR0", i32 7, i32 9}
...
const unsigned char PixelShader_ps_ps[] = {
  0x44, 0x58, 0x42, 0x43, 0x71, 0x72, 0xbd, 0x72, 0x30, 0xda, 0x83, 0x76,
  0x44, 0x7c, 0xf2, 0x95, 0xed, 0x13, 0x21, 0xcc, 0x01, 0x00, 0x00, 0x00,
  0xc1, 0x0a, 0x00, 0x00, 0x05, 0x00, 0x00, 0x00, 0x34, 0x00, 0x00, 0x00,
  ...
  0x00, 0x00, 0x00, 0x00, 0x00, 0x44, 0x58, 0x49, 0x4c, 0xc8, 0x08, 0x00,
  0x00, 0x60, 0x00, 0x00, 0x00, 0x32, 0x02, 0x00, 0x00, 0x44, 0x58, 0x49,
  0x4c, 0x00, 0x01, 0x00, 0x00, 0x10, 0x00, 0x00, 0x00, 0xb0, 0x08, 0x00,
  0x00, 0x42, 0x43, 0xc0, 0xde, 0x21, 0x0c, 0x00, 0x00, 0x29, 0x02, 0x00,
  ...
  0x06, 0x00, 0x00, 0x00, 0x00, 0x89, 0x20, 0x00, 0x00, 0x4e, 0x00, 0x00,
  ...
  0x7e, 0x87, 0x30, 0x44, 0x23, 0x21, 0x4e, 0x23, 0x21, 0x02, 0x00, 0x00,
  0x68, 0xdd, 0x33, 0x5c, 0xfe, 0x84, 0x3d, 0x84, 0xe4, 0x87, 0x40, 0x33,
  0x2c, 0x04, 0x0a, 0x62, 0x21, 0x20, 0x90, 0x80, 0xe6, 0x4d, 0xc3, 0xe5,
  0x4f, 0xd8, 0x43, 0x48, 0xfe, 0x4a, 0x48, 0x2b, 0x31, 0xf9, 0xc5, 0x6d,
  0xa3, 0x62, 0x8c, 0x31, 0x40, 0x61, 0x2a, 0x90, 0x72, 0x8c, 0x31, 0x00,
  0x00, 0x83, 0xec, 0x1c, 0x41, 0x50, 0x0c, 0x09, 0x16, 0x00, 0x98, 0xf2,
  0x40, 0xc0, 0x30, 0x82, 0x30, 0xdc, 0x23, 0x4d, 0x11, 0x25, 0x4c, 0x7e,
  0xca, 0xfe, 0xe2, 0x99, 0xba, 0x2d, 0x1a, 0x08, 0xe1, 0xc9, 0x00, 0x00,
  ...
  ,
  ...
  0x57, 0x36, 0x25, 0xc0, 0x83, 0x3a, 0x64, 0x78, 0x2e, 0x65, 0x6e, 0x74,
  0x72, 0x79, 0x50, 0x6f, 0x69, 0x6e, 0x74, 0x73, 0x53, 0x02, 0x56, 0x00,
  ...
  ,
